...
void apertura ( unsigned int *imgdata , unsigned int *aux_img ,bmpInfoHeader bInfoHeader)
{
  erosion_5 ( imgdata , aux_img , bInfoHeader);
  dilata_5 ( imgdata , aux_img , bInfoHeader);
